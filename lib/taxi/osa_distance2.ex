defmodule MyApp.OSMDistance do
  ...
  @doc """
  Geocode an address to coordinates, restricted to Armenia, Quindío
  """
  defp geocode_address(address) when is_binary(address) do
    # Enhance address with location if not already included
    search_query = if String.contains?(String.downcase(address), "armenia") do
      address
    else
    ...
    params = [
      ...
      viewbox: @armenia_bbox,  # Focus area
